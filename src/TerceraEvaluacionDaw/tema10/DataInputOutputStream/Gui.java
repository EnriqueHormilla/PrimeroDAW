...
public class Gui extends JFrame implements ActionListener, WindowListener {
    ...
    private CursorCliente cursorCliente;
    private int dniTemporal = -1;

    public Gui() {
        //Me creo un objeto de cursorCliente
        cursorCliente = new CursorCliente();
    ...
    public void windowOpened(WindowEvent we) {
        cursorCliente.leerRegistro();
        rellenarInical();
    }

    @Override
    public void windowClosing(WindowEvent we) {
        cursorCliente.escribirRegistro();
        mensajePantalla("Guardado todo en los registros.");
    }
