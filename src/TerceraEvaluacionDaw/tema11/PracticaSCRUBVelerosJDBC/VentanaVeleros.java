 ...
 * @author Enrique
 */
public class VentanaVeleros extends JInternalFrame implements ActionListener, InternalFrameListener {
    ...
    private ImplementacionDAO implementacion;
    private int dniTemporal = -1;

    public VentanaVeleros() {
        //Me creo un objeto de cursorCliente
        implementacion = new ImplementacionDAO();
...
//        }
    ...
    public static void main(String[] args) {
        VentanaVeleros a=new VentanaVeleros();
    }
}
